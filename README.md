...
│
├── Postman/
│   ├── User_API_Tests.json                 # Postman collection with API requests (GET, POST)
│   └── Api Testing User API Tests.xlsx     # Excel table with test cases and expected results
│
├── JMeter/
│   └── Thread Group.jmx                    # JMeter scenario for performance testing (1 vs 10 users)
│
├── Reports/
│   └── Performance Testing Report.pdf      # Final performance report with analysis and conclusions
